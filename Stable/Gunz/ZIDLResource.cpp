...
ZItemSlotView* ZIDLResource::GetItemSlot(MXmlElement& element)
{
	...
	else if (!_stricmp(szParts, "avatar"))		pWidget->SetParts(MMCIP_AVATAR);
	...
	else if (!_stricmp(szParts, "community1"))	pWidget->SetParts(MMCIP_COMMUNITY1);
	else if (!_stricmp(szParts, "community2"))	pWidget->SetParts(MMCIP_COMMUNITY2);
	else if (!_stricmp(szParts, "longbuff1"))	pWidget->SetParts(MMCIP_LONGBUFF1);
	else if (!_stricmp(szParts, "longbuff2"))	pWidget->SetParts(MMCIP_LONGBUFF2);
	else if (!_stricmp(szParts, "dash")) pWidget->SetParts(MMCIP_DASH);
